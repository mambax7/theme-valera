...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<{xoImgUrl}>css/flexslider.css">
    <link rel="stylesheet" type="text/css" href="<{xoImgUrl}>color/default.css">
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
	...
	<script src="<{xoImgUrl}>js/slippry.min.js"></script> 
	<script src="<{xoImgUrl}>js/jquery.flexslider-min.js"></script>
	<script src="<{xoImgUrl}>js/morphext.min.js"></script>
	<script src="<{xoImgUrl}>js/gmap.js"></script>
	<script src="<{xoImgUrl}>js/jquery.mb.YTPlayer.js"></script>
	...
	<script src="<{xoImgUrl}>js/jquery.nicescroll.min.js"></script>
